...
% Les contraintes d'inegalités sont dans le losange 
...
cvx_begin quiet % quiet pour �viter l'affichage des iterations de cvx
    variable mu(n); % declarer que theta est la variable du prob, vecteur de taille n
    minimize (0.5*quad_form(mu,H) +q'*mu) % fonction objectif
